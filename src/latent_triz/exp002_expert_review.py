...
def validate_review_packets(
    ...
    for packet in packets:
        ...
        if observed != expected:
            raise Exp002ExpertReviewError("each reviewer must cover the full question bank")
        packet_coverage.append(observed)
    return {
...
__all__ = ["Exp002ExpertReviewError", "summarize_review_packets", "validate_review_packets"]
