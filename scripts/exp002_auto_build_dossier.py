...
def main() -> int:
    ...
    dossier = {
        ...
        "material_bindings": {
            "runner_sha256": _sha256(ROOT / "src/latent_triz/exp002_auto_material.py"),
            "adapter_sha256": _sha256(ROOT / "src/latent_triz/exp001_comparative_adapter.py"),
            "analysis_sha256": _sha256(ROOT / "src/latent_triz/exp002_auto_analysis.py"),
            "sealed_key_schema_sha256": _sha256(ROOT / "schemas/exp002-auto-sealed-target-key.schema.json"),
            "model_registry_sha256": _sha256(root / "model-registry.json"),
            "public_key_template_sha256": _sha256(root / "combined-target-key-template.json"),
        },
