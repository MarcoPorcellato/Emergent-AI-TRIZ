...
exp002-runner-test:
	PYTHONPATH=$(PYTHONPATH) $(LAB01_PYTHON) -m unittest tests.test_exp002_runner tests.test_exp002_stage_cli tests.test_exp002_answer_key tests.test_exp002_freeze_answer_key_cli tests.test_exp002_transfer_corpus tests.test_exp002_validate_transfer_corpus_cli tests.test_exp002_stage_gate tests.test_exp002_expert_review tests.test_exp002_source_familiarity tests.test_exp002_power
